  ...
  return (
    <div className="fixed bottom-8 right-8 z-[60] max-w-sm">
      <div className="liquid-glass p-4 rounded-2xl flex gap-4 items-start border border-white/10 bg-black/40">
        ...
        <div>
          <h4 className="text-sm font-bold text-white mb-1">Connect Convex</h4>
          <p className="text-xs text-white/60 leading-relaxed">
            Database feature is live! Add your VITE_CONVEX_URL to the secrets panel to start syncing real content.
          </p>
        </div>
      </div>
    </div>
